      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-black text-base-content">Crear Ruta</h1>
        ...
        {rutasCreadas.length > 0 && (
          <div className="mt-8">
            <h2 className="text-sm font-semibold text-base-content/60 mb-3 uppercase tracking-wider">
            ...
            <div className="flex flex-col gap-2">
              {rutasCreadas.map((r, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 p-3 bg-base-100/50 rounded-lg border border-base-content/5"
                >
