...
export class CreateUserDto {
  ...
  @ApiProperty({ description: 'Dirección de correo electrónico única', example: 'juan.perez@example.com' })
  @IsEmail()
  @IsNotEmpty()
  email: string;
  ...
  @ApiPropertyOptional({ description: 'URL de la imagen de identificación cargada en checkout', example: 'https://minio/bucket/id.jpg' })
  @IsUrl()
  @IsOptional()
